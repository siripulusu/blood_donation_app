...
class EditProfileScreen extends StatefulWidget {
  ...
  const EditProfileScreen({super.key, this.donorData});
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    if (widget.donorData != null) {
      ...
      phoneController.text = widget.donorData!['phone'] ?? '';
      ageController.text = widget.donorData!['age']?.toString() ?? '';
      selectedBloodGroup = widget.donorData!['bloodGroup'];
      selectedGender = widget.donorData!['gender'];
      selectedState = widget.donorData!['state'];
      selectedCity = widget.donorData!['city'];
      if (widget.donorData!['lastDonated'] != null) {
        lastDonatedDate = DateTime.parse(widget.donorData!['lastDonated']);
      }
    }
  }
